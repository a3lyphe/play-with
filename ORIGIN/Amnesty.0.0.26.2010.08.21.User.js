//Amnesty.0.0.26.2010.08.21.User.js
alert((
	'°Amnesty.0.0.26.2010.08.21.User.js°:'
	+'\n++\tCollected User Components and prototyped methods'
	+'\n++\t'
	+'\n++\t'
));
...
//270
	...
	)
	{
		document.images[NR].src
		=
			this.icon.list[45].src
		;
	}
}

C.User.Class.prototype.link
=
	C.User.Method.link
;
C.User.Class.prototype.isPassing
=
	C.User.Method.isPassing
;
C.User.Class.prototype.isFollowing
=
	C.User.Method.isFollowing
;
C.User.Class.prototype.isEscaping
=
	C.User.Method.isEscaping
;
C.User.Class.prototype.eats
=
	C.User.Method.eats
;
C.User.Class.prototype.SpeedBerechnung
=
	C.User.Method.SpeedBerechnung
;
C.User.Class.prototype.KI
=
	C.User.Method.KI
;
C.User.Class.prototype.KIdir
=
	C.User.Method.KIdir
;
C.User.Class.prototype.mind
=
	C.User.Method.mind
;
C.User.Class.prototype.wind
=
	C.User.Method.wind
;
C.User.Class.prototype.roto
=
	C.User.Method.roto
;
