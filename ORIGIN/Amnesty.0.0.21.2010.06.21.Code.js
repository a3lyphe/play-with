alert(('°Amnesty.0.0.21.2010.06.21.Code.js°:'
	+'\n++\tCode.js is now °Amnesty.0.0.21.2010.06.21.Code.js°'
	+'\n++\t°theWelt=new Welt()° has been replaced with °new C.Welt.Class()° due to new naming Conventions in °Amnesty.0.0.21.2010.06.21°'
	+'\n++\t'
));
//+Init
var Maximum=0;
