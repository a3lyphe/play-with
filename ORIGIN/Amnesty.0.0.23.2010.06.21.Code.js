//Amnesty.0.0.23.2010.06.21.Code.js
alert((
	'°Amnesty.0.0.23.2010.06.21.Code.js°:'
	+'\n++\t°theWelt°, the generated Instance used until now is buffered back into the newly built °C.Welt.Instance°-Buffer of °Amnesty.0.0.22.2010.06.21.Welt.js to guarantee that everything functions normally, but can be file-wise updated to the new buffer.'
	+'\n++\t'
	+'\n++\t'
));
