//Amnesty.0.0.26.2010.08.21.Player.js
alert((
	'°Amnesty.0.0.26.2010.08.21.Player.js:'
	+'\n++\tprototyped class Player'
	+'\n++\t'
	+'\n++\t'
));
...
(wer)
{
	...
	return((
		(
			map[Math.floor(this.yFuture)][Math.floor(this.xFuture)]
			>
			wer
		)
		&&
...
C.Player.Method.SpeedBerechnung
=
function
(
	WR
...
)
{
	...
	)
	{
		...
		=
			'hidden'
		;
		$('Havanna').style.visibility
		=
			'hidden'
		;
		$('IschtukKontor').style.visibility
		=
			'hidden'
		;
		$('IschtukHafen').style.visibility
		=
			'hidden'
		;
		$('IschtukTaverne').style.visibility
		=
			'hidden'
		;
		$('IschtukTaverneLeute').style.visibility
		=
			'hidden'
		;
		$('HavannaKontor').style.visibility
		=
			'hidden'
		;
		$('HavannaHafen').style.visibility
		=
			'hidden'
		;
		$('HavannaTaverne').style.visibility
		=
			'hidden'
		;
...
C.Player.Class.prototype.link
=
	C.Player.Method.link
;
C.Player.Class.prototype.isPassing
=
	C.Player.Method.isPassing
;
C.Player.Class.prototype.isFollowing
=
	C.Player.Method.isFollowing
;
C.Player.Class.prototype.isEscaping
=
	C.Player.Method.isEscaping
;
C.Player.Class.prototype.SpeedBerechnung
=
	C.Player.Method.SpeedBerechnung
;
C.Player.Class.prototype.KI
=
	C.Player.Method.KI
;
C.Player.Class.prototype.KIdir
=
	C.Player.Method.KIdir
;
C.Player.Class.prototype.mind
=
	C.Player.Method.mind
;
C.Player.Class.prototype.wind
=
	C.Player.Method.wind
;
C.Player.Class.prototype.roto
=
	C.Player.Method.roto
;
